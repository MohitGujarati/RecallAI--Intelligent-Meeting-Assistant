package com.mohit.recall_ai.model
...
sealed class RecordingState {
    ...
    data class Recording(
        ...
        val audioSource: com.mohit.recall_ai.data.local.entity.AudioSource =
            com.mohit.recall_ai.data.local.entity.AudioSource.BUILT_IN
    ) : RecordingState()
